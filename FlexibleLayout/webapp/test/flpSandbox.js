		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapdemoflexiblelayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapdemoflexiblelayout-display": {
								"semanticObject": "comsapdemoflexiblelayout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.demo.flexiblelayout",
									"url": sap.ui.require.toUrl("com/sap/demo/flexiblelayout")
								}
							}
						}
					}
